...
public:
  ...
  ~Texture() { cout << "Destructing " << description() << endl; }
...
class Sprite {
public:
  Sprite(int width, int height, int x, int y, const string &textureFileName)
  ...
  ~Sprite() {
    cout << "Destructing sprite with texture " << m_Texture->description()
         << endl;
    delete m_Texture;
  }
