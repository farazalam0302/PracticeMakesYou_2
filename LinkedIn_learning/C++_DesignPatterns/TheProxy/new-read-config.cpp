...
public:
  ...
  vector<string> getSettings() override { return settings; }
...
public:
  explicit ConfigFileProxy(const string &filename)
      : filename(filename), realConfigFile(nullptr) {
    cout << "ConfigFileProxy created \n";
  }
